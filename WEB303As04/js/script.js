        ...
        function getCurrentLocation() {
            if ("geolocation" in navigator) {
                navigator.geolocation.getCurrentPosition(function (position) {
                    ...
                    $("#locationhere").text(`Current Location: ${latitude}, ${longitude}`);
                    ...
                    if (previousLocation) {
                        ...
                        $("#previousLocation").text(`Previous Location: ${parsedPreviousLocation.latitude}, ${parsedPreviousLocation.longitude}`);
